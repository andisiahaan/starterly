<x-layouts.main :title="'Tag: ' . $tag->name . ' - Blog'">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white mt-4">#{{ $tag->name }}</h1>
            @if($tag->description)
            <p class="text-slate-600 dark:text-slate-400 mt-2">{{ $tag->description }}</p>
            @endif
        </div>
